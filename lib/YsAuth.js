...
exports.resetPassword = exports.logout = exports.login = exports.confirmSignup = exports.signup = exports.YsAuthAmpliftConfig = exports.getIdleTimeConfigure = void 0;
var aws_amplify_1 = __importStar(require("aws-amplify"));
var DEFAULT_IDLE_TIME = 3600000;
var IdleTimeConfigure = DEFAULT_IDLE_TIME;
var setIdleTimeConfigure = function (idleTime) {
    IdleTimeConfigure = idleTime;
};
var getIdleTimeConfigure = function () {
    return IdleTimeConfigure;
};
exports.getIdleTimeConfigure = getIdleTimeConfigure;
var YsAuthAmpliftConfig = function (props) {
...
var signup = function (email, username, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, aws_amplify_1.Auth.signUp({
                        username: username,
                        password: password,
                        attributes: {
                            email: email,
...
var confirmSignup = function (username, code) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, aws_amplify_1.Auth.confirmSignUp(username, code)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, response];
            case 2:
...
var login = function (username, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, aws_amplify_1.Auth.signIn(username, password)];
            case 1:
                user = (_a.sent());
                return [2 /*return*/, {
...
var logout = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, aws_amplify_1.Auth.signOut()];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
...
var resetPassword = function (username, code, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, aws_amplify_1.Auth.forgotPasswordSubmit(username, code, password)];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
