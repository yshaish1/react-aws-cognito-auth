...
var YsProvider = function (_a) {
    ...
    return (react_1.default.createElement(exports.AuthContext.Provider, { value: { login: login, logout: logout, resetPassword: resetPassword, getCurrentUser: getCurrentUser, error: error, loading: loading } }, children));
};
