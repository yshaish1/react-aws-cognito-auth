...
var YsAuthProvider = function (_a) {
    ...
    return (react_1.default.createElement(exports.AuthContext.Provider, { value: { login: login, logout: logout, getCurrentUser: getCurrentUser, error: error, loading: loading, user: authState } }, children));
};
